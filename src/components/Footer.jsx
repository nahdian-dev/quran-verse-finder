        ...
        <div className="grid grid-cols-1 grid-flow-row">
            <div className="flex flex-col bg-primary p-20 text-center">
                ...
                <div className="flex justify-center items-center gap-4">
                    {/* Instagram */}
                    <a href="https://www.instagram.com/nahdiann/" className="fill-white">
                    ...
                    {/* LinkedIn */}
                    <a href="https://www.linkedin.com/in/nah-dian-40952a1a5/" className="fill-white">
                    ...
                    {/* Youtube */}
                    <a href="https://www.youtube.com/channel/UC474qnpwuP7syXqFJUKfLKA" className="fill-white">
